...
# Introduction
The version 2.2 of Sindhi data consists of 402,426 words (16,448 sentences).
No sentence id was available in the original resource, so new `sent_id` was automatically introduced in the converted corpus with prefixes `fr-ud-train`, `fr-ud-dev` and `fr-ud-test` on the correponding original files, followed by a 5 digit number following the order of sentences.
